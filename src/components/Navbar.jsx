    ...
    return (
      <nav className="navbar navbar-expand-lg navbar-default">
        ...
        <form onSubmit={this.props.handleSubmit} className="form-inline my-lg-0 navbar-search">
            ...
            <button className="navbar-search-button btn btn-outline-secondary my-2 my-sm-0" id="button-addon2"> <i className="fa fa-search" aria-hidden="true"></i> Search</button>
        </form>
